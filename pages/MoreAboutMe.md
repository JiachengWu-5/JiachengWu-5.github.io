...
## Skills
- **Programming Languages**: Python, C++, Java, MATLAB, HTML
- **Machine Learning Frameworks**: PyTorch, TensorFlow
- **Scientific Writing**: LaTeX, Markdown
- **Media Processing**: Adobe Premiere, Photoshop, Lightroom
- **Circuit Design & MCU Programming**: Raspberry Pi, STM32F103, Arduino UNO, FPGA
